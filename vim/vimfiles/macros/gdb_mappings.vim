...
function! s:Toggle()
    ...
    if g:vimgdb_debug_file == ""
        ...
        call inputsave()
        let g:vimgdb_debug_file = input("File: ", g:vimgdb_debug_file , "file")
        call inputrestore()
    endif
    ...
    if ! exists("g:vimgdb_debug_args")
        let g:vimgdb_debug_args = ""
    endif
    if g:vimgdb_debug_args == ""
        call inputsave()
        let g:vimgdb_debug_args = input("Arguments: ", "", "file")
        call inputrestore()
    else
        call inputsave()
        let g:vimgdb_debug_args = input("Arguments: ", g:vimgdb_debug_args , "file")
        call inputrestore()
    endif

    call gdb("set args " . g:vimgdb_debug_args)
	...
	" display Visual selected expression
	vmap <silent> <C-X> y:call gdb("createvar *" . "<C-R>"")<CR>
